                        ...
                        <div class="col-lg-3 col-md-8 col-8">
                            ...
                            <script>
                                function showLoginMessage() {
                                    alert('You must be logged in to display your wishlist');
                                    // Hoặc hiển thị thông báo theo ý của bạn, chẳng hạn sử dụng modal dialog
                                }
                            </script>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                        <li class="footer-menu-item"><a href="{{route('fe.aboutus')}}">About us</a></li>
                                        <li class="footer-menu-item"><a href="{{route('fe.blog')}}">Our magazine</a></li>
                                        <li class="footer-menu-item"><a href="{{route('fe.contact')}}">Work with us</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                        <li class="footer-menu-item"><a href="{{route('fe.category',$item->id)}}">Categogy</a></li>
                                        <li class="footer-menu-item"><a href="{{route('fe.product')}}">Product</a></li>
                                        <li class="footer-menu-item"><a href="{{route('fe.cart')}}">Cart</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                        <li class="footer-menu-item"><a href="{{route('fe.faq')}}">FAQ</a></li>
                                        <li class="footer-menu-item"><a href="{{route('fe.aboutus')}}">Privacy policy</a></li>
                                        <li class="footer-menu-item"><a href="{{route('fe.contact')}}">Contact</a></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="footer-newsletter">
                                        ...
                                        <div class="newsletter-wrapper">
                                            <form action="#" class="footer-newsletter-form d-flex align-items-center">
                                                ...
                                                <button href="{{route('fe.register')}}" class="footer-newsletter-btn" type="submit">SIGN
                                                    UP</button>
                                            </form>
                                        </div>
                ...
                <div  class="container">
                    <div
                        ...
                        <ul class="footer-bottom-menu list-unstyled d-flex flex-wrap align-items-center mb-0">
                            <li class="footer-menu-item"><a style="color: white" href="">Your Site Name</a></li>
                            <li class="footer-menu-item"><a style="color: white" href="{{route('fe.home')}}">Light My Desk</a></li>
                        </ul>
