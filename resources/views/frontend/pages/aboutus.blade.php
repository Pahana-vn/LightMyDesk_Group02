...
<style>
    .action-count {
    background-image: url("../../../../public/frontend/img/about2/count-bg.png");
...
<div class="about-page">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="about-hero-content">
                        <h2 class="about-hero-title">We specialize in providing high-end table lamps nationwide for foreign export</h2>
                        <p class="about-hero-subtitle">We provide a full range of lights depending on usage needs and good user experience</p>
                        <ul class="about-hero-action p-0">
                            <li class="action-item d-flex">
                                <div class="action-count">01</div>
                                <div class="action-content">
                                    <h4 class="action-title"><a href="#">Dedicated consultation</a></h4>
                                    <p class="action-subtitle">You will receive 24/7 support with online or in-person consulting, answering all your questions.</p>
                                </div>
                            </li>
                            <li class="action-item d-flex">
                                <div class="action-count">02</div>
                                <div class="action-content">
                                    <h4 class="action-title"><a href="#">Product, good quality</a></h4>
                                    <p class="action-subtitle">Having been approved by the company, the product is absolutely safe and does not cause harm.</p>
                                </div>
                            </li>
                            <li class="action-item d-flex">
                                <div class="action-count">03</div>
                                <div class="action-content">
                                    <h4 class="action-title"><a href="#">Delivery on schedule</a></h4>
                                    <p class="action-subtitle">No delay, once the order is received it will be shipped immediately.</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="about-hero-img">
                        <img src="{{asset('public/frontend')}}/img/about2/about-hero.jpg" alt="img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-0 justify-content-center">
            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="300">
                <div class="promotional-item overlay-blue">
                    <img src="{{asset('public/frontend')}}/img/about2/p1.jpg" alt="img">
                    <div class="promotional-absolute">
                        <div class="promotional-content text-center">
                            <h2 class="promo-title">Serving our customers is always our top priority</h2>
                            <p class="promo-subtitle">We offer a full range of table lamps for all brands and styles</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="700">
                <div class="promotional-item overlay-black">
                    <img src="{{asset('public/frontend')}}/img/about2/p2.jpg" alt="img">
                    <div class="promotional-absolute">
                        <div class="promotional-content text-center">
                            <h2 class="promo-title">Become the world's leading company in lighting business solutions.</h2>
                            <p class="promo-subtitle">We are a company specializing in domestic and foreign sales, complete documents, good production and consumer quality.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="1000">
                <div class="promotional-item overlay-yellow">
                    <img src="{{asset('public/frontend')}}/img/about2/p3.jpg" alt="img">
                    <div class="promotional-absolute">
                        <div class="promotional-content text-center">
                            <h2 class="promo-title">We value the service we provide and our loyal returning customers </h2>
                            <p class="promo-subtitle">Customers and consumers who come to our store receive free consultation and actual product experience.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-12 py-4" data-aos="fade-up" data-aos-duration="1000">
                        <div class="about-service-inner text-center">
                            ...
                            <div class="about-service-content">
                                ...
                                <p class="about-service-subtitle">LightMyDesk will deliver to your home, on schedule without delay, with many shipping options</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12 py-4" data-aos="fade-up" data-aos-duration="1400">
                        <div class="about-service-inner text-center">
                            ...
                            <div class="about-service-content">
                                <h4 class="about-service-title">Easy installation</h4>
                                <p class="about-service-subtitle">LightMyDesk products are easy to use and come with manual instructions, you can rest assured about how it works</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12 py-4" data-aos="fade-up" data-aos-duration="1700">
                        <div class="about-service-inner text-center">
                            ...
                            <div class="about-service-content">
                                ...
                                <p class="about-service-subtitle">Prices are published directly on the website and without intermediaries. Prices go hand in hand with product quality</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="team-wrapper">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="team-item">
                                <img src="{{asset('public/frontend')}}/img/team/hai.jpg" alt="img">
                                <div class="member-absolute">
                                    <div class="member-details text-center">
                                        <h4 class="member-name">Lê Ngọc Hải</h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="team-item">
                                <img src="{{asset('public/frontend')}}/img/team/nhan2.jpg" alt="img">
                                <div class="member-absolute">
                                    <div class="member-details text-center">
                                        <h4 class="member-name">Phạm Hoài Nhân</h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="team-item">
                                <img src="{{asset('public/frontend')}}/img/team/phuc.jpg" alt="img">
                                <div class="member-absolute">
                                    <div class="member-details text-center">
                                        <h4 class="member-name">Ngô Tấn Phúc</h4>
    ...
    class="about-banner mt-100" data-aos="fade-up" data-aos-duration="700">
        <div class="container">
            <div  class="about-banner-wrapper">
                <div class="about-banner-content">
                    ...
                    <a href="{{route('fe.contact')}}" class="about-banner-btn">CONTACT US</a>
                </div>
            </div>
        </div>
    </div>
