                        ...
                        <div id="filter-collection" class="accordion-collapse collapse show">
                            <ul class="filter-lists list-unstyled mb-0">
                                ...
                                <li class="filter-item">
                                    <a href="{{route('fe.category',$item->id)}}" class="filter-label">
                                        <input type="checkbox" />
                        ...
                        <div class="filter-related">
                            ...
                            <div class="related-item d-flex">
                                <div class="related-img-wrapper">
                                    <img class="related-img" src="{{asset('public/file')}}/image/{{$item->image}}"
                                        alt="img">
                                </div>
                                <div class="related-product-info">
                                    ...
                                    <p class="related-price text_16">${{$item->price}}</p>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
