                        ...
                        <div class="product-card-img">
                            ...
                            <div class="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal-{{$item->id}}" class="action-card action-quickview"
                                    data-bs-toggle="modal" data-href="#quickview-modal-{{$item->id}}">
                                    ...
                                    <div class="product-details ps-lg-4">
                                        ...
                                        <div class="misc d-flex align-items-end justify-content-between mt-4">
                                            ...
                                            <div class="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                                                ...
                                                <button href="#" class="product-wishlist btn_like" data-id="{{ $item->id }}">
        ...
        ?>
                ...
                <div class="scattered-item" data-aos="fade-left" data-aos-duration="700">
                    <div class="scattered-wrapper">
                        <a href="{{route('fe.category',$item->id)}}" class="scattered-content">
    ...
    <div class="modal fade" tabindex="-1" id="video-modal">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe height="600" src="https://www.youtube.com/watch?v=9jGOOmCo93k"
            ...
            <div class="brand-logo-container overflow-hidden">
                ...
                ?>
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                        data-aos-duration="700">
                        <div href="index.html" class="brand-logo d-flex align-items-center justify-content-center">
...
<script>
    ...
    $(document).ready(function() {
        $(".action-quickview").click(function(e) {
        e.preventDefault();
        var hrefValue = $(this).data("href");

        $(hrefValue).find(".arrow-slider.arrow-next.slick-arrow[aria-disabled='false']").click();
    });
