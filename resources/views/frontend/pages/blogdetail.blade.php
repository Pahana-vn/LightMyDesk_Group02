                ...
                <div class="article-rte">
                    ...
                    <div class="article-meta">
                        ...
                        <div class="article-card-published text_14 d-flex align-items-center">
                            ...
                            <span href="#" class="article-date d-flex align-items-center" >
                            ...
                            <a href="{{route('fe.product')}}" class="article-date d-none d-sm-flex align-items-center">
                                <span class="icon-tag">
                    ...
                    <div class="comments-section mt-100 home-section overflow-hidden">
                        ...
                        <div class="comment-form-area">
                            ...
                            <form action="{{route('rating.store')}}" class="comment-form" method="post">
                                @csrf
                                ...
                                <div class="field-item textarea-field">
                                    ...
                                    <textarea cols="20" rows="6" name="content" placeholder="Write your comment here........"></textarea>
                                </div>
