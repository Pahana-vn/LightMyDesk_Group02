            ...
            <div class="col-lg-6 col-md-12 col-12">
                <div class="product-details ps-lg-4">
                    ...
                    @php
                        ...
                        $averageRating = count($ratingValues) > 0 ? array_sum($ratingValues) / count($ratingValues) : 0;
                    @endphp
                    <div class="product-rating d-flex align-items-center mb-3">
                        ...
                        <span class="rating-count ms-2">({{count($ratings)}})</span>
                    </div>
                    ...
                    <div class="misc d-flex align-items-end justify-content-between mt-4">
                        ...
                        <div class="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                            <button id="themgiohang" class="position-relative btn-atc ">ADD TO CART</button>
            ...
            <div id="preview" class="tab-pane fade">
                <div class="review-area accordion-parent">
                    ...
                    <div class="review-header d-flex flex-column">
                        <div id="comment-move" class="comments-area">
                            @if(count($ratings) > 0)
                                @foreach($ratings as $rating)
                                <div class="d-flex comments-item">
                                <div class="comments-img">
                                    <img src="{{asset('public/file/')}}/people/{{ rand(1,9) }}.jpg"
                                    alt="img">
                                </div>
                                <div class="comments-main">
                                    <h4 class="commentator-name">{{$rating->name}}</h4>
                                    <div class="comments-date article-date d-flex align-items-center commentator-name">
                                        ...
                                        <span class="ms-2">{{$rating->created_at}}</span>
                                    </div>
                                    @if($rating->rating)
                                        @for($i = 0; $i < $rating->rating; $i++)
                                            <svg class="commentator-name" width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M15.168 5.77344L10.082 5.23633L8 0.566406L5.91797 5.23633L0.832031 5.77344L4.63086 9.19727L3.57031 14.1992L8 11.6445L12.4297 14.1992L11.3691 9.19727L15.168 5.77344Z" fill="#FDCC0D"/>
                                            </svg>
                                        @endfor

                                    @endif
                                    <h5 class="commentator-name">{{$rating->title}}</h5>
                                    <p>{{$rating->content}}</p>
                                </div>
                                </div>
                                @endforeach
                        ...
                        <a class="text_14 bg-transparent text-decoration-underline write-btn pt-3" type="button">Write a review</a>
                    </div>
...
{{--                        </script>--}}
                        <form action="{{route('rating.store')}}" method="post">
                            ...
                            <fieldset>
                                <label class="label" onclick="ratingInput(2)">Full Name</label>
                            ...
                            <fieldset>
                                ...
                                <div class="star-rating">
                                    <button onclick="ratingInput(event,1)">
                                        <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <button onclick="ratingInput(event,2)">
                                        <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15.168 5.77344L10.082 5.23633L8 0.566406L5.91797 5.23633L0.832031 5.77344L4.63086 9.19727L3.57031 14.1992L8 11.6445L12.4297 14.1992L11.3691 9.19727L15.168 5.77344Z" fill="#B2B2B2"/>
                                        </svg>
                                    </button>
                                    <button onclick="ratingInput(event,3)">
                                        <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15.168 5.77344L10.082 5.23633L8 0.566406L5.91797 5.23633L0.832031 5.77344L4.63086 9.19727L3.57031 14.1992L8 11.6445L12.4297 14.1992L11.3691 9.19727L15.168 5.77344Z" fill="#B2B2B2"/>
                                        </svg>
                                    </button>
                                    <button onclick="ratingInput(event,4)">
                                        <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15.168 5.77344L10.082 5.23633L8 0.566406L5.91797 5.23633L0.832031 5.77344L4.63086 9.19727L3.57031 14.1992L8 11.6445L12.4297 14.1992L11.3691 9.19727L15.168 5.77344Z" fill="#B2B2B2"/>
                                        </svg>
                                    </button>
                                    <button onclick="ratingInput(event,5)">
                                        <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15.168 5.77344L10.082 5.23633L8 0.566406L5.91797 5.23633L0.832031 5.77344L4.63086 9.19727L3.57031 14.1992L8 11.6445L12.4297 14.1992L11.3691 9.19727L15.168 5.77344Z" fill="#B2B2B2"/>
                                        </svg>
                                    </button>
                            ...
                            <fieldset>
                                ...
                                <textarea cols="30" rows="10" name="content" placeholder="Write your comments here"></textarea>
                            </fieldset>
...
@push('scripts')
<script>
    function ratingInput(e,value) {
        e.preventDefault();
        $('#rating').val(value);
        $("button").removeClass("rating-yellow");
        $(".star-rating button:lt(" + value + ")").addClass("rating-yellow");
    }
</script>
@endpush
@endsection
